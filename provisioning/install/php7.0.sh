...
apt install -y php7.0-mysql php7.0-xml php7.0-curl php7.0-soap php7.0-gd php7.0-bz2 php7.0-mbstring php7.0-zip php7.0-intl php7.0-dev php7.0-xdebug php7.0-redis php7.0-ldap
